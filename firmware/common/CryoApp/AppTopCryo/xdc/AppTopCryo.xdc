...
create_clock -name jesdClk00 -period 3.256 [get_ports {jesdClkP[0][0]}]
create_clock -name jesdClk01 -period 3.256 [get_ports {jesdClkP[0][1]}]
create_clock -name jesdClk02 -period 3.256 [get_ports {jesdClkP[0][2]}]
create_clock -name jesdClk03 -period 3.256 [get_ports {jesdClkP[0][3]}]
create_clock -name jesdClk10 -period 3.256 [get_ports {jesdClkP[1][0]}]
create_clock -name jesdClk11 -period 3.256 [get_ports {jesdClkP[1][1]}]
create_clock -name jesdClk12 -period 3.256 [get_ports {jesdClkP[1][2]}]
create_clock -name jesdClk13 -period 3.256 [get_ports {jesdClkP[1][3]}]