...
export SURF_DIR=/u/lt/jvasquez/sandbox/github/surf
export AMCC_DIR=/u/lt/jvasquez/sandbox/github/amc-carrier-core
export TIMING_DIR=/u/lt/jvasquez/sandbox/github/lcls-timing-core
export APPCORE_DIR=${PWD}/..//firmware/common/DemoBoardCryoApp/AppCore
